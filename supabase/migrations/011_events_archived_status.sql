-- =============================================
-- Migration: 011_events_archived_status.sql
...
-- value (verified failing against the live DB: updating an event to
-- 'archived' violates events_status_check). Drop and re-add the
-- constraint with 'archived' included so event archiving works.
--
